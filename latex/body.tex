...
\begin{hebrew}מדרג המרקם — מקשה ועד נוזלי — מסמן זמני שהייה לומינליים משתנים; צואה קשה (טיפוסים 1--2) מעידה על מעבר ממושך עקב תנועתיות מופחתת או ספיגת מים מוגברת (ראו איור~\ref{fig:F7}).\end{hebrew}
