...
\begin{figure}[h]\centering
\includegraphics[width=0.8\textwidth]{../assets/F10.png}
...
\begin{figure}[h]\centering
\includegraphics[width=0.8\textwidth]{../assets/F7.png}
...
\begin{figure}[h]\centering
\includegraphics[width=0.8\textwidth]{../assets/F2.png}
...
\begin{figure}[h]\centering
\includegraphics[width=0.8\textwidth]{../assets/F3.png}
...
\begin{figure}[h]\centering
\includegraphics[width=0.8\textwidth]{../assets/F8.png}
...
\begin{figure}[h]\centering
\includegraphics[width=0.8\textwidth]{../assets/F4.png}
...
\begin{figure}[h]\centering
\includegraphics[width=0.8\textwidth]{../assets/F5.png}
...
\begin{figure}[h]\centering
\includegraphics[width=0.8\textwidth]{../assets/F6.png}
...
\begin{figure}[h]\centering
\includegraphics[width=0.8\textwidth]{../assets/F9.png}
...
\begin{hebrew}\textbf{שילוב במערכות אסלה חכמה.} חיישנים ספקטרופוטומטריים המשולבים במערכות אסלה חכמה (\textenglish{smart toilet}) יכולים לבצע מדידת \textenglish{CIEDE2000} בזמן אמת ולספק משוב מיידי על מאפייני הצואה \cite{jagc2026}. גישה זו מאפשרת ניטור אורכי רציף ללא מאמץ מצד המשתמש.\end{hebrew}
